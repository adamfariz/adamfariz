...
*   📍 **Current Status:** Building AI-integrated tools and actively open to full-time Software Engineering roles
...
| :--- | :--- | :--- |
| 🛠️ **[Chrome Live Audio Fact-Checker](https://github.com/adamfariz)** | Extension + backend that transcribes live browser audio and fact-checks claims in real time via the Groq API. | `Chrome APIs` `Node.js` `Express` `Groq` |
| 🚘 **[Covoit Air](https://github.com/adamfariz)** | Mobile airport ridesharing platform featuring Stripe payments and multi-role JWT/RBAC security. | `React Native` `Node.js` `MongoDB` |
...
<div align="center">
  ...
  <img src="https://raw.githubusercontent.com/adamfariz/adamfariz/output/github-contribution-grid-snake.svg8&cache_seconds=1800" alt="Snake Animation" width="100%" />
</div>
...
<div align="center">
  ...
  <a href="mailto:farizadam20051027@gmail.com"><img src="https://img.shields.io/badge/Email-farizadam20051027%40gmail.com-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Email" /></a>
</div>
